...
describe("The packet parser test suite", function(){
  ...
  var packet2 = new Buffer([0x73, 0x6E, 0x70, 0x19, 0x18, 0x17, 0x16, 0x15, 0x14, 0x13, 0x12, 0x11, 0x10, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01, 0x00]);
  ...
  it("should parse two packets", function(){
    var result = 0;
    var r0 = new Buffer(23);
    var r1 = new Buffer(23);
    ...
    expect(r0.toString("hex")).toEqual(packet.toString("hex"));
    expect(r1.toString("hex")).toEqual(packet2.toString("hex"));
